...
class profile(models.Model):
    ...
    institute = models.CharField(max_length=60, blank=True, null=True)
    qnumber = models.CharField(max_length=60, blank=True, null=True)
    ...
    def avatar(self):
        ...
        if self.use_gravatar:
            ...
            self.avatar_url = "/static/upload/default.png"

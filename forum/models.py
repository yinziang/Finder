...
class appendix(models.Model):                   #附言
    topic = models.ForeignKey(topic)
    time_created = models.DateTimeField(auto_now_add=True)
    content = models.TextField()
    content_rendered = models.TextField()
...
#     current_user = models.ForeignKey(User, related_name='main_user')               #当前用户
#     attention_user = models.ForeignKey(User, related_name='attention_user')        #当前用户所关注的用户